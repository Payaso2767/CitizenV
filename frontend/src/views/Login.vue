<template>
  ...
  <div id="formContent">
    <!-- Tabs Titles -->
    <h3 class="text-center text pt-5">Đăng nhập</h3>

    <!-- Login Form -->
    <form @submit.prevent="login">
      <input v-model="input.username" type="text" id="Username" class="fadeIn second" name="login" placeholder="Tên đăng nhập">
      <input v-model="password1" type="password" id="password" class="fadeIn third" name="login" placeholder="Mật khẩu">
      <input type="submit" class="fadeIn fourth" value="Đăng nhập">
    </form>

    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="#">Quên mật khẩu? Liên hệ ... để được cấp lại.</a>
    </div>
